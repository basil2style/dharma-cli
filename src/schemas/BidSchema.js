...
var BidSchema = function (_Schema) {
  ...
  function BidSchema(web3) {
    ...
    var schema = {
      ...
      minInterestRate: new _Schema2.NumberType()
    };

    return _possibleConstructorReturn(this, (BidSchema.__proto__ || Object.getPrototypeOf(BidSchema)).call(this, 'Bid', schema));
  }
